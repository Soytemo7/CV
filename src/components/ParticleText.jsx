...
function ParticleText({
  ...
  useEffect(() => {
     ...
     * IMPORTANTE:
     *
     * La animación permanece detenida
     * hasta que ParticleText entra
    ...
    # START ANIMATION
    #
    # Igual que GravityGallery:
    # esperamos a que el componente
    # entre en pantalla.
    # Después esperamos 150ms.
    ==========================================================*/
    ...
    const startAnimation =
      () => {
        ...
        /*
         * Los 150ms son únicamente
         * para que el inicio del efecto
         * sea perceptible.
         */
        startTimeout =
          window.setTimeout(
    ...
    const sampleText =
      async () => {
        ...
        let font =
          `${fontWeight} ${resolvedSize}px ${resolvedFamily}`;
         ...
         * IMPORTANTE:
         *
         * Aquí ya NO iniciamos
         * startGather() automáticamente.
         *
         * Si el componente todavía
         * está fuera de pantalla,
         * esperamos al IntersectionObserver.
         */
        if (
          started
        ) {
    ...
    #
    # Igual que GravityGallery.
    # La animación solamente comienza
    ...
    /*
     * Construimos las partículas,
     * pero NO iniciamos la animación.
     */
    sampleText();
